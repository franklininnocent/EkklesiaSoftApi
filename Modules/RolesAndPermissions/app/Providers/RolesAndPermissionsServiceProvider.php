...
namespace Modules\RolesAndPermissions\Providers;
...
class RolesAndPermissionsServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'RolesAndPermissions';

    protected string $nameLower = 'rolesandpermissions';
    ...
    public function boot(): void
    {
        ...
        $this->publishes([
            module_path($this->name, 'config/rolesandpermissions.php') => config_path('rolesandpermissions.php'),
